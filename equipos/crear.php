...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errores) {
        $stmt = $db->prepare("INSERT INTO equipos (nombre_pc, mac, ip, subred, tipo_conexion, aula, sala, piso, curso, sistema_operativo, usuario_asignado, claves_info, observaciones, estado)
            VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
        $stmt->execute([
